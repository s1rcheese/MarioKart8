 ...
 *  Modified by Nintendo. 2014-04-01
 *
 *
...
static SBC_INLINE void sbc_analyze_four_simd(const int16_t *in, int32_t *out,
...
static SBC_INLINE void sbc_analyze_eight_simd(const int16_t *in, int32_t *out,
							const FIXED_T *consts)
{
	FIXED_A t1[8];
	FIXED_T t2[8];
...
static SBC_INLINE void sbc_analyze_4b_4s_simd(int16_t *x,
...
static SBC_INLINE void sbc_analyze_4b_8s_simd(int16_t *x,
					  int32_t *out, int out_stride)
{
	/* Analyze blocks */
...
static SBC_INLINE int16_t unaligned16_be(const uint8_t *ptr)
{
	return (int16_t) ((ptr[0] << 8) | ptr[1]);
}

static SBC_INLINE int16_t unaligned16_le(const uint8_t *ptr)
{
...
static SBC_INLINE int sbc_clz(uint32_t x)
{
#ifdef __GNUC__
