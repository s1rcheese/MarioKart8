...
static SBC_INLINE void sbc_analyze_four_iwmmxt(const int16_t *in, int32_t *out,
...
static SBC_INLINE void sbc_analyze_eight_iwmmxt(const int16_t *in, int32_t *out,
							const FIXED_T *consts)
{
	__asm__ volatile (
		"wldrd        wr0, [%0]\n"
...
static SBC_INLINE void sbc_analyze_4b_4s_iwmmxt(int16_t *x, int32_t *out,
						int out_stride)
{
	/* Analyze blocks */
...
static SBC_INLINE void sbc_analyze_4b_8s_iwmmxt(int16_t *x, int32_t *out,
						int out_stride)
{
	/* Analyze blocks */
